...
function HomeScreen() {
    ...
    return (
        <div className={`duration-700 px-4 md:px-20 ${(myContext.menu || myContext.title !== 'Welcome') ? "mt--1 opacity-0" : "pt-40 "}`}>
            ...
            <p className='text-2xl mx-2 sm:mx-20 md:mx-40 sm:p-2 my-6 text-center font-medium'>As a former industrial automation engineer and manufacturer, I have transitioned into a fulfilling career as a developer. Explore my projects and learn more about my journey and expertise in programming.</p>
            <div className='flex mx-auto w-80 font-semibold justify-evenly text-2xl'>
            ...
            <div className='home-button'>TEST</div>
        </div>
    )
}
