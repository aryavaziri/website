...
function Reframe() {
    ...
    return (
        <div
            ...
            className={`${myContext.theme ? `border-vr2 text-vr2 bg-vr` : `border-vr1 text-slate-200 bg-vr`} relative w-screen font-custom2 px-4 sm:px-16 md:px-32 pb-12 duration-500 overflow-hidden ${(myContext.menu || myContext.title !== 'Reframe') ? "mt--2 opacity-0" : " delay-300"}`} >
            ...
            <div className='sm:flex justify-between my-6'>
                <div className='basis-2/5 flex flex-col gap-2 p-2'>
                    <div className='flex gap-2 items-baseline'>
                        <div className={`${myContext.theme ? `text-vr2` : `text-vr1`} w-32 text-right text-2xl`} >Client:</div>
                        <div className='text-lg' >Civic Interaction Design</div>
                    </div>
                    <div className='flex gap-2 items-baseline'>
                        <div className={`${myContext.theme ? `text-vr2` : `text-vr1`} w-32 text-right text-2xl`}>Techsnologies:</div>
                        <div className='text-lg' >C#/UNITY, 3D, VR</div>
                    </div>
                    <div className='flex gap-2 items-baseline'>
                        <div className={`${myContext.theme ? `text-vr2` : `text-vr1`} w-32 text-right text-2xl`}>Date:</div>
            ...
            <div>
                <div className={`${myContext.theme ? `text-vr2` : `text-vr1`} text-3xl p-2`} >Design Proposal</div>
            ...
            <div>
                <div className={`${myContext.theme ? `text-vr2` : `text-vr1`} text-3xl p-2`}>Unity</div>
            ...
            <div className='my-8'>
                <div className={`${myContext.theme ? `text-vr2` : `text-vr1`} text-3xl p-2 my-2`}>Experience Demo</div>
